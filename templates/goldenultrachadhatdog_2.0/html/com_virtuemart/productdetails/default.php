...
<div class="productdetails-view productdetails" >
	...
	<div style="clear:both;">
		<ul class="ttr_prodes_Tab_Title nav nav-tabs" >
			<li class="active">
				<a class="nav-link " href="#home" data-toggle="tab"><?php echo vmText::_('COM_VIRTUEMART_PRODUCT_DESC_TITLE') ?></a>
			</li>
			<li>
	...
	<?php if (!empty($this->product->product_desc)) { ?>
		...
		<?php	
		if (is_array($this->productDisplayShipments) && !empty($this->productDisplayShipments)) {
		    foreach ($this->productDisplayShipments as $productDisplayShipment)
			{ 
				if(!empty($productDisplayShipment))
				{ // add this check to manage the Array displaying issue for Specification Tab in case of empty array
					if(is_array($productDisplayShipment))
					{
						foreach($productDisplayShipment as $productDisplayShip)
						{
							echo $productDisplayShip;
						}
					}
					else
					{
		...
		if (is_array($this->productDisplayPayments) && !empty($this->productDisplayPayments)) {
		    foreach ($this->productDisplayPayments as $productDisplayPayment) {
				if(!empty($productDisplayPayment))
				{ // add this check to manage the Array displaying issue for Specification Tab in case of empty array
					if(is_array($productDisplayPayment))
					{
						foreach($productDisplayPayment as $productDisplayPay)
						{
							echo $productDisplayPay;
						}
					}
					else
					{
		...
		<?php
		 // Product Packaging    	
		$product_packaging = '';
    	if ($this->product->product_box && !empty($this->product->product_box)) {
